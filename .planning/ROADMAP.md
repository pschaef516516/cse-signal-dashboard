...
**Plans:** 6 plans
- [ ] 02-01-PLAN.md — Data layer: filterByDateRange, groupBySourceAndType, export getISOWeekLabel, fetchSignals/fetchPosts column expansion, fetchSignalsByDate, fetchPostsByDate
